...
class DataSourceConfig(_message.Message):
    ...
    TRACEALYZER_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    tracealyzer_config: TracealyzerConfig
...
class TracealyzerConfig(_message.Message):
    __slots__ = ["file_path"]
